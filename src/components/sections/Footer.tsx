        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            ...
            <p className="text-sm text-gray-400 leading-relaxed mb-4">
              Les Privat ke Rumah untuk Anak SD &amp; SMP di Pekanbaru. Belajar lebih nyaman, fokus, dan efektif.
            </p>
            <a
              href={WHATSAPP_URL}
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 bg-green-500 hover:bg-green-600 text-white px-4 py-2.5 rounded-xl text-sm font-semibold transition-all hover:scale-105"
            >
